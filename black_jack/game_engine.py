...
def run_game():
    ...
    while int(balance) > 0 and choise != 'quit' and bet != 'quit':  
        ...
        curent_diller_value = int(cards_value[numbers.index(dil_num1)]) + int(cards_value[numbers.index(dil_num2)])
        ...
        curent_player_value = int(cards_value[numbers.index(pl_num1)]) + int(cards_value[numbers.index(pl_num2)])
        ...
        if choise == 'more':
            ...
            print('Player: ' + str(curent_player_value))
            make_cards.print_player_three_cards(pl_num1, pl_simb1, pl_num2, pl_simb2, pl_num3, pl_simb3)
        ...
        if choise == 'stop':
            ...
            balance = process_function.determine_winner(curent_player_value, curent_diller_value, balance, bet)
            if balance < 1:
